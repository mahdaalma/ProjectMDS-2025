...
server <- function(input, output) {
  ...
  output$bar_chart1 <- renderPlotly({
    ...
    plot_ly(data_filtered, x = ~nama_univ, y = ~jumlah_mahasiswa, type = 'bar',color="hotpink",
  ...
  output$bar_chart2 <- renderPlotly({
    ...
    plot_ly(data_filtered, x = ~nama_univ, y = ~jumlah_dosen, type = 'bar', color="hotpink",
            text = ~jumlah_dosen, 
            insidetextanchor = 'start', 
            insidetextfont = list(color = 'navy')) %>% 
  ...
  output$bar_chart3 <- renderPlotly({
    ...
    plot_ly(data_filtered, x = ~nama_univ, y = ~daya_tampung, type = 'bar',color="hotpink",
            text = ~daya_tampung, 
            insidetextanchor = 'start', 
            insidetextfont = list(color = 'navy')) %>% 
